...
import { AppBar, Avatar, Box, Drawer, Hidden, IconButton, isWidthUp, List, ListItem, ListItemIcon, ListItemText, Toolbar, Tooltip, Typography, withStyles, withWidth, } from "@material-ui/core";
						...
						<ListItem disableGutters className={classNames(classes.iconListItem, classes.smBordered)}>
							...
							{isWidthUp("sm", width) && (
								<ListItemText
									...
									primary={
										<Typography color="textPrimary">{storage.get("username")}</Typography>
									}
								/>
							)}
						</ListItem>
